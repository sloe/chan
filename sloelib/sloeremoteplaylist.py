...
class SloeRemotePlaylist(SloeTreeNode):
    MANDATORY_ELEMENTS = ("common_id", "name", "remote_id", "remote_url")

    def __init__(self):
        SloeTreeNode.__init__(self, "remoteplaylist", "0b")
    ...
    def __repr__(self):
        return "|RemotePlaylist|%s" % pformat(self._d)


SloeTreeNode.add_factory("REMOTEPLAYLIST", SloeRemotePlaylist)
