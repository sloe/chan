...
class SloePluginAfterEffects(sloelib.SloeBasePlugIn):
    ...
    def __init__(self, *params):
        ...
        sloelib.SloeGenSpec.OPTIONAL_ELEMENTS.update({
            "aftereffects_outputcomp": "After Effects output composition name",
            "aftereffects_outputfilename": "After Effects output file name",
            "aftereffects_outputmodule": "After Effects output module name",
            "aftereffects_project": "After Effects output project filename"
        })
